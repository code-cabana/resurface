...
export default function Hero() {
  ...
  return (
    <>
      ...
      <p>
        Ever received "0 results" when searching for some code that you know is
        just off-screen?
      </p>
      <p>
        Wouldn't it be great to get auto-complete suggestions while writing code
        similar to searching something via Google?
      </p>
      <p>
