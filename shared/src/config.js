...
export const salesPage = "https://resurface.codecabana.com.au";
export const accountPage = `${salesPage}/account`;
export const resetPasswordPage = `${salesPage}/reset-password`;
